...
export const metadata = {
	title: 'Register | CoDriver',
};

export default function Register({ params }: { params: { type: string } }) {
	const type = (params.type as string) || '';
	if (!(type === 'driver' || type === 'staff')) {
	...
	const handleSubmit = async (e: any) => {
		...
		if (
			...
			return console.log('Invalid form data', JSON.stringify(valid));
		try {
	...
	return (
		<div className='flex justify-center'>
			<form className='p-2 w-full max-w-md'>
				<h5 className='text-lg pb-2 text-center mt-6 mb-7'>
					Sign Up - {type.charAt(0).toUpperCase() + type.slice(1)}
				</h5>
				...
				<div className='mb-2'>
					<div className='flex items-center mb-2'>
						...
						<label htmlFor='tos'>
							Agree to the&nbsp;
							<a href='/tos' className='link link-primary underline'>
								Terms Of Service
							</a>
						</label>
					</div>
