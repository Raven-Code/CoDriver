...
export default function Navbar({ type }: { type: string }): JSX.Element {
	if (type === 'customer') {
		return (
					...
					<div className='dropdown'>
						...
						<ul
							...
							<li>
								...
								<ul className='p-2'>
									<li>
										<a href='/register/driver'>Driver Account</a>
									</li>
									<li>
										<a href='/register/staff'>Staff Account</a>
									</li>
								</ul>
							</li>
							<li>
